...
const ZemblPhoneInput = ({ control, name, label, required, defaultCountry, dropdownClass, disabled, readOnly }: ZemblPhoneInputProps) => {
      ...
      <Controller
        ...
        render={({ field: { ref, ...field } }) => (
          <PhoneInput
            ...
            buttonClass={`!rounded-md active:!border-gray-900 focus:!border-gray-900 ${!!disabled || !!readOnly ? 'pointer-events-none' : ''}`}
            inputClass={`text-zembl-p ml-5 left-11 text-blue-gray-700 outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 border focus:border-2 border-t-transparent focus:border-t-transparent text-sm !px-3 py-2.5 !rounded-[7px] border-blue-gray-200 bg-white !h-10 !w-[calc(100%-44px)] focus:!border-gray-900 ${disabled ? '!bg-blue-gray-50' : ''}`}
