...
const EANewConnectionVIC = ({ control, awarePowerOff, electricPrice, gasPrice }: EANewConnectionVICProps) => {
  ...
  const infoText =
    awarePowerOff === ON_VALUE
      ...
      : `To ensure your power is connected, you must make sure the main switch is turned off prior to the connection date. The connection fee for your ${priceText} including GST, which will appear on your first bill. A technician will require clear access to the main switch and/or meter. Please ensure there are no access restrictions such as locked gates and unrestrained animals as you may be charged additional fees if the provider incurs additional costs.`
