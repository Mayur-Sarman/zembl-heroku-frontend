...
const MomentumNewConnectionQLD = ({ connectionPrice, control, powerAware }: MomentumNewConnectionQLDProps) => {
...
interface MomentumNewConnectionQLDProps {
  connectionPrice: number
  control: Control
  powerAware: string
}

export default MomentumNewConnectionQLD
