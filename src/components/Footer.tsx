    ...
    >
      <Typography variant="paragraph" className="text-xs lg:text-base">
        *Zembl Pty Ltd (ABN 29138847757) helps you compare energy and gas plans and providers. Not all plans or
        ...
        sold through the website. Click <a className="text-white-600 underline" href="https://www.zembl.com.au/suppliers">here</a> to view Zembl’s range of retail providers.
      </Typography>
