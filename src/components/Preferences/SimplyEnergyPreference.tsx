  ...
  return (
    ...
    <AccordionCard alwaysOpen open title="Simply Energy Preferences" bodyClassName="flex-col text-left gap-y-6">
      ...
      <TextNote className='text-sm'>
        {`You can change the method you receive your bills anytime by contacting customer service. By switching to receive your bills via ${word}, you will be charged a fee of $1.65 including GST.`}
      </TextNote>
    </AccordionCard>
  )
}
